...
const steps = [
  {
    ...
    description: 'We adapted options pricing theory to forecast impermanent loss before it happens. 73% prediction accuracy on historical data.',
  ...
  },
  {
    ...
    description: 'When IL risk exceeds threshold, automatically switch to safe lending protocols. Maximize returns while minimizing risk.',
  ...
  },
  {
    ...
    description: 'Seamlessly integrate with Octant to fund public goods. Your yields work harder AND support the ecosystem.',
...
export function SolutionSection() {
  return (
    <section id="how-it-works" className="py-20 sm:py-32 relative bg-muted/30 flex items-center justify-center">
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            DeltaGuard uses research-grade mathematics to predict and prevent impermanent loss, 
            protecting DAO treasuries while maximizing public goods funding.
          </p>
        </motion.div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="p-6 rounded-xl bg-muted/50 border border-destructive/30">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs text-muted-foreground">Naive Strategy</span>
                  </div>
                  
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-sm text-muted-foreground">Fee APY</span>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-yellow-500">+3.5%</span>
                    </div>
                ...
                {/* DeltaGuard */}
                <div className="p-6 rounded-xl bg-gradient-to-br from-primary/10 to-secondary/10 border border-primary/30 relative overflow-hidden">
                  {/* Glow effect */}
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="font-semibold">Net Return</span>
                        <span className="text-xl font-bold text-green-500">+7.9%</span>
                      </div>
                      <div className="p-3 rounded-lg bg-primary/10 border border-primary/20 mt-2">
                        <div className="text-xs text-muted-foreground mb-1">Annual Profit</div>
                        <div className="text-lg font-bold text-primary">$79,000</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-border">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-500 mb-1">75%</div>
                  <div className="text-xs text-muted-foreground">Less IL</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary mb-1">126%</div>
                  <div className="text-xs text-muted-foreground">Better Returns</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-500 mb-1">+$44k</div>
                  <div className="text-xs text-muted-foreground">Additional Profit</div>
                </div>
              </div>
            </CardContent>
          </Card>
