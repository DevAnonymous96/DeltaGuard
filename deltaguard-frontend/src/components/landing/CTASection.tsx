...
export function CTASection() {
  return (
    <section className="py-20 sm:py-32 relative overflow-hidden flex items-center justify-center">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-secondary/20 to-background gradient-animate" />
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Join the future of intelligent liquidity management. 
            No wallet required to explore our IL simulator.
          </p>
